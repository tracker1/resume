...
- C# with .Net Core and FastEndpoints for the back-end services, with Dapper against Microsoft SQL Server.
- React on the front-end with Mantine UI for components and Zustand for state management.
...
Design lead and principal developer on the platforms used to expose and interact with customer driven API services. Broader architecture standards were set company wide; my scope was the API surface, its design and its implementation.
